...
/**
 * @author gugu
 * @Classname AnalyserLogDataMapper
...
//        获取事件名称
    ...
    private void handleData(Map<String, String> clientInfo, EventLogConstants.EventEnum event, Context context) throws IOException, InterruptedException {
