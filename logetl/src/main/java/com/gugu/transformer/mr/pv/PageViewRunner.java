 ...
 * @Description 计算website的pv值的mapreducer入口类<br/>
...
public class PageViewRunner extends TransformerBaseRunner {
    ...
    protected Filter fetchHbaseFilter() {
        ...
        // 只需要pageview事件
        filterList.addFilter(new SingleColumnValueFilter(PageViewMapper.family, Bytes.toBytes(EventLogConstants.LOG_COLUMN_NAME_EVENT_NAME), CompareFilter.CompareOp.EQUAL, Bytes.toBytes(EventLogConstants.EventEnum.PAGEVIEW.alias)));
        // 定义mapper中需要获取的列名
