...
import com.gugu.transformer.util.TimeChain;
 ...
 * @Description 计算会话个数和会话时长的一个reducer类
 * @Date 2020/1/12 18:22
 */
public class SessionsReducer extends Reducer<StatsUserDimension, TimeOutputValue, StatsUserDimension, MapWritableValue> {
     ...
     * @param context
     * @return void
     * @Description 处理添加browser维度的sessions分析
     * @params
     * @auther gugu
     */
