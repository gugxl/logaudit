 ...
 * @Description 统计location维度信息的入口类
...
public class LocationRunner extends TransformerBaseRunner {
    ...
    protected Filter fetchHbaseFilter() {
        ...
        // 过滤只需要pageview事件
        list.addFilter(new SingleColumnValueFilter(LocationMapper.family, Bytes.toBytes(EventLogConstants.LOG_COLUMN_NAME_EVENT_NAME), CompareFilter.CompareOp.EQUAL, Bytes.toBytes(EventLogConstants.EventEnum.PAGEVIEW.alias)));
        return list;
    }
}
